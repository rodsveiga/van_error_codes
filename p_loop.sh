...
#    python main_.py --N 250 --M 500 --K 4 --p $p --p_prior 0.5 --num_messages 100 --max_step 1000 --save_model --net made --net_depth 2 --net_width 3  --beta_anneal 0.998 --clip_grad 1 --save_step 500 --save_model --print_grad --tensorboard --log --cuda 0 --laptop
#done
